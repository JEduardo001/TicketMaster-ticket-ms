...
import com.swSoftware.asientos.ticket_ms.infrastructure.adapter.output.kafka.KafkaProducer;
import com.swSoftware.asientos.ticket_ms.infrastructure.adapter.output.persistence.OutboxEventRepository;
...
import static com.swSoftware.asientos.ticket_ms.infrastructure.shared.LogMessages.*;
...
public class OutboxEventService<T> implements IOutboxEventService<T> {
    ...
    public void saveEvent(T request,String nameTopic){
        String payloadJson = request.toString();
